            ...
            setter?.apply {
                ...
                body = IrBlockBuilder(
                    ...
                    val cinteropCall = irCall(
                        ...
                        // Slot zero is the dispatch receiver in Kotlin 2.2's unified argument list.
                        var argumentIndex = 1
                        arguments[argumentIndex++] = irGet(objectReferenceType, tmp.symbol)
                        arguments[argumentIndex++] = irString(property.persistedName)
                        arguments[argumentIndex] = realmValue
                    }
